...
public class BindableItemCursorAdapter extends CursorAdapter {
	...
	public abstract interface BindableItemBinder {
		/**
		 ...
		 */
		public abstract int getBindableItemTypeCount();
		/**
		 ...
		 *  
		 * @param context	Conext of request
		 * @param view		View to populate
		 * @param cursor	Cursor, positions at the relevant row
		 * @param event		Event, retrieved from cursor
		 */
		public abstract void bindViewToItem(Context context, View view, BindableItemSQLiteCursor cursor, BindableItem bindable);
	}
	...
	public BindableItemCursorAdapter(BindableItemBinder binder, Context context, BindableItemSQLiteCursor cursor) {
		super(context, cursor) ; //context, layout, c, from, to);
	...
	private Hashtable<String,Integer> m_itemTypeLookups = new Hashtable<String,Integer>();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
		...
		if(convertView == null) {
			try {
                ...
                //convertView = newListItemView(mInflater, EventListActivity.this, cursor, parent, event);					
			} catch (Exception e) {
