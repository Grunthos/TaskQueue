...
public interface BindableItem {
	 ...
	 * @return			a new view
	 */
	public abstract View newListItemView(final LayoutInflater inflater, final Context context, final BindableItemSQLiteCursor cursor, final ViewGroup parent);
	/**
	 ...
	 * @return
	 */
	public abstract boolean bindView(final View view, final Context context, final BindableItemSQLiteCursor cursor, final Object appInfo);
	/**
	 ...
	 * @param appInfo	Any application-specific object the caller chooses to send. eg. a database adapter.
	 */
	public void addContextMenuItems(final Context ctx, AdapterView<?> parent, final View v, final int position, final long id, final ArrayList<ContextDialogItem> items, final Object appInfo);
}
